...
global.ownername = process.env.OWNER_NAME === undefined ? "ᴍɪɢ ᴍǫɴ 👻" : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '237657124529' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
global.ownernumber = [`${fake}`]
global.premium = [`${fake}`]
global.anticall = process.env.ANTICALL === undefined ? 'false' : process.env.ANTICALL
global.packname = process.env.PACK_NAME === undefined ? 'ᴍɪɢ' : process.env.PACK_NAME
global.author = process.env.STICKER_AUTHOR_NAME === undefined ? 'ᴍǫɴ 👻' : process.env.STICKER_AUTHOR_NAME
